...
# CORS Settings
CORS_ALLOW_ALL_ORIGINS = True  # In production, set to specific frontend domains
...
AWS_TEXTRACT_REGION_NAME = os.getenv('AWS_TEXTRACT_REGION_NAME', 'us-east-1')

# Company settlement parameters
COMPANY_COMMISSION_PERCENTAGE = 15.0  # 15% commission on gross earnings by default
